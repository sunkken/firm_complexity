...
- [ ] Add enrichment columns to the output dataset.
  - [ ] Add CIK code column to dataset.
  - [ ] Add filing_date column to dataset.
  - [ ] Add form_type column to dataset.
  - [ ] Add period_end_date column to dataset.
